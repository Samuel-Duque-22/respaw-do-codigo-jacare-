## Equipe apenas tentando reviver — Padaria Triguinho
sem projetos apenas o samuel fazendo o que der na telha
...
- [ ] Ciclos 8 a 10 — `backend/`: formulário que grava e lista do banco# respaw-do-codigo-jacare-
